...
namespace SlipStream.Client.Agos
{
    ...
    public partial class App : Application
    {
        ...
        private ISlipStreamClient clientService;
        ...
        internal CompositionContainer Container
        {
            get
            {
                ...
                if (container == null)
                {
                    ...
                    var catalog2 = new AssemblyCatalog(typeof(SlipStreamClient).Assembly);
        ...
        public ISlipStreamClient ClientService
        {
            get
            {
